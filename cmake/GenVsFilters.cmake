function(GenVsFilters FileGroup)
    foreach(sourceFile IN LISTS ${FileGroup})
        ...
        elseif(sourceFile MATCHES "[\\/]?private[\\/]")
            # Set the base folder to the 'private' directory.
            file(RELATIVE_PATH relPath "${CMAKE_CURRENT_SOURCE_DIR}/private" "${sourceFile}")
            set(groupBase "private")
